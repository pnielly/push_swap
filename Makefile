...
#    Updated: 2021/04/26 11:01:09 by user42           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INC=-I includes
SRC_PATH=src
SRCS= builtins.c reverse_rotate.c errors.c rotate.c print_lst.c exec_cmd.c push.c swap.c display_stacks.c elaborate_utils.c elaborate_utils_2.c elaborate_utils_3.c elab_small.c elab_100.c elab_500.c
