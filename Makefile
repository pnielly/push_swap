...
#    Updated: 2021/04/28 18:07:00 by user42           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INC=-I includes
SRC_PATH=src
SRCS= builtins.c reverse_rotate.c errors.c rotate.c print_lst.c exec_cmd.c push.c swap.c display_stacks.c elaborate_utils.c elaborate_utils_2.c elab_small.c elab_big.c elab_big_utils.c
