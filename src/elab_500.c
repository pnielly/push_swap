...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/26 11:01:52 by user42            #+#    #+#             */
/*   Updated: 2021/04/26 11:41:21 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
static int	ft_suivant(t_list *tmp, int prec)
{
	int	suiv;
...
static int	remains_in_a(t_list *a, int thr_inf, int thr_sup)
{
	t_list	*tmp;
...
static void	order_b(t_list **b, t_list **a)
{
	int	max;
...
static void	fill_b(t_list **a, t_list **b, int thr_inf, int thr_sup)
{
	int	next;
	int	floor;
...
static void	calibrate_a(t_list **a, t_list **b)
{
	int	floor;
...
//	group_size = ft_lstsize(*a) / 10;
//	groups = ft_lstsize(*a) / group_size;
